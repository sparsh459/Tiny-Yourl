...
SECRET_KEY = 'django-insecure-lu2q$-nf$e(wvc5!az*--nv8j7-r^)q&aso6rd+)fooqmtm4yq'
...
# manually putting templates path in DIRS 
TEMPLATES = [
    {
...
# manaually putting static directory path
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
